...
#### Command to add POS Kohlmann

```shell
curl --header "Content-Type: application/json" --request POST --data '{"name":"Bäkerei Kohlmann GmbH","description":"only 2.3 stars on google, would not recommend","type":"BAKERY","campus":"INF","street":"Im Neuenheimer Feld","houseNumber":"370","postalCode":69120,"city":"Heidelberg"}' http://localhost:8080/api/pos
```

#### Command to check if POS was added correctly
```shell
